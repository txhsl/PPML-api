package org.txhsl.ppml.api.service.ml;
...
public class EncryptedMultinomialNaiveBayes extends BaseUpdateableClassifier implements Parameterized
{
     ...
     */
    public EncryptedMultinomialNaiveBayes()
    {
        this(1.0);
    }
     ...
     */
    public EncryptedMultinomialNaiveBayes(double smoothing)
    {
     ...
     */
    protected EncryptedMultinomialNaiveBayes(EncryptedMultinomialNaiveBayes other)
    {
    ...
    @Override
    public EncryptedMultinomialNaiveBayes clone()
    {
        return new EncryptedMultinomialNaiveBayes(this);
    }
