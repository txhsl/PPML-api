...
public class EncryptedNaiveBayes implements Classifier, Parameterized
{
...
//            }
     ...
     */
    public EncryptedNaiveBayes(NumericalHandeling numericalHandling)
    {
    ...
    @Override
    public EncryptedNaiveBayes clone()
    {
        EncryptedNaiveBayes newBayes = new EncryptedNaiveBayes(numericalHandling);
